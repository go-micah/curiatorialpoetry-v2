module github.com/go-micah/curatorialpoetry-v2
...
require (
	...
	github.com/go-micah/clevelandart v0.0.0-20231214152046-630b401c93db
	github.com/go-micah/go-bedrock v0.0.4
)
...
require (
	...
	github.com/aws/aws-sdk-go-v2/service/bedrockruntime v1.5.5 // indirect
